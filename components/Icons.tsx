...
export const MagicWandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.386 5.042a15.998 15.998 0 00-1.622-3.385m-5.043.025a15.998 15.998 0 01-3.388-1.621m7.702 4.062a3 3 0 00-1.128-5.78 2.25 2.25 0 01-2.245-2.4 4.5 4.5 0 00-2.245-8.4c-.399 0-.78.078-1.128.22a15.998 15.998 0 00-1.621 3.385m5.042.025a15.998 15.998 0 01-1.622 3.385m3.386 5.042a15.998 15.998 0 01-3.388 1.621m-5.043-.025a15.998 15.998 0 00-3.388 1.622m-1.621-5.043a15.998 15.998 0 00-1.622 3.385" />
    </svg>
);
